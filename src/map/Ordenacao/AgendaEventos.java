...
//		// Adiciona eventos à agenda
		agendaEventos.adicionarEvento(LocalDate.of(2023, Month.JULY, 15), "Conferência de Tecnologia",
				"Palestrante renomado");
		agendaEventos.adicionarEvento(LocalDate.of(2023, 12, 9), "Workshop de Programação",
